...
const RatingsItem = ({ fav }) => {
  ...
  const getRating = (event) => {
    setRating(prevRating =>  event.target.value);
  }
              ...
              <div className="ms-2 me-auto">
                ...
                <option value="⭐⭐⭐⭐⭐">5 Stars</option>
                  ...
                  <div className="form-group form-check">
                    ...
                    htmlFor="exampleCheck1">Handicap Access?</label>
                  </div>
                </div>
          <span key={fav._id}  value={fav.name} onChange={() => this.handleChange(fav.name)} className="badge bg-primary rounded-pill">{ Rating }</span>
            </li>
      </ol>
      </RatingsTrail>
    </div>
